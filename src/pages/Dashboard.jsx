        ...
        <div className=" rounded-xl  mb-6 w-full">
          <div className="flex justify-between items-center mb-4 px-2">
            ...
            <button class="group relative flex  bg-[#00285b]  gap-2 rounded-xl px-2 py-2 text-sm font-medium shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]">
              <div class="absolute inset-0 block h-full w-full animate-gradient bg-gradient-to-b from-white/60 from-2% to-[#00285b]/50 to-10% bg-[length:var(--bg-size)_100%] [border-radius:inherit] [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] pt-[2px] ![mask-composite:subtract]"></div>
